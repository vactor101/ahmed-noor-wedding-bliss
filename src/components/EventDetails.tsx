    ...
    <section className="py-20 bg-wedding-warm">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          {/* Wedding Reception */}
          <div className="text-center bg-white rounded-2xl p-8 shadow-soft animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="mb-6">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center justify-center gap-2 text-muted-foreground">
                <Clock className="w-5 h-5" />
                <span>تبدأ الساعة 9:00 مساءً</span>
              </div>
              
              <p className="text-center font-amiri arabic-text text-lg leading-relaxed">
                نرحب بكم لمشاركتنا أجمل لحظاتنا<br />
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-soft max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
            ...
            <Button 
              ...
              onClick={() => window.open('https://maps.app.goo.gl/omK2jNprVw3DvZhJ6?g_st=iw', '_blank')}
            >
