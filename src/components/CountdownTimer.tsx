...
const CountdownTimer = () => {
  ...
  useEffect(() => {
    const weddingDate = new Date('2025-07-31T20:00:00').getTime();
  ...
  return (
    <div className="flex justify-center gap-8 mt-8 font-playfair">
      <div className="text-center animate-scale-in" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="text-sm md:text-base text-muted-foreground arabic-text">أيام</div>
      </div>
      ...
      <div className="text-center animate-scale-in" style={{ animationDelay: '0.4s' }}>
        ...
        <div className="text-sm md:text-base text-muted-foreground arabic-text">ساعات</div>
      </div>
      ...
      <div className="text-center animate-scale-in" style={{ animationDelay: '0.6s' }}>
        ...
        <div className="text-sm md:text-base text-muted-foreground arabic-text">دقائق</div>
      </div>
      ...
      <div className="text-center animate-scale-in" style={{ animationDelay: '0.8s' }}>
        ...
        <div className="text-sm md:text-base text-muted-foreground arabic-text">ثواني</div>
      </div>
    </div>
  );
};
