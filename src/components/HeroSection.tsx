...
const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-10 right-10 text-wedding-gold opacity-30 animate-float" style={{ animationDelay: '1s' }}>
        <svg width="60" height="60" viewBox="0 0 60 60" fill="currentColor">
          <path d="M30 0l7.5 22.5H60L42.5 35 50 57.5 30 45 10 57.5 17.5 35 0 22.5h22.5L30 0z"/>
        </svg>
      </div>
      ...
      <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="mb-8 text-lg md:text-xl">
            ...
            <p className="text-2xl md:text-3xl font-bold text-wedding-gold mb-2">31-7-2025</p>
