      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <div className="flex justify-center items-center gap-3 mb-6">
            ...
            <Heart className="w-8 h-8 text-wedding-gold animate-float" style={{ animationDelay: '1s' }} />
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400 font-amiri arabic-text">31 يوليو 2025</p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-400 font-amiri arabic-text">مكان الحفل</p>
          </div>
          
          <div className="text-center">
            <Heart className="w-8 h-8 text-wedding-gold mx-auto mb-3" />
            <h5 className="font-playfair font-semibold mb-2">Celebration</h5>
            <p className="text-wedding-gold">8:00 PM</p>
            <p className="text-sm text-gray-400 font-amiri arabic-text">الساعة 8:00 مساءً</p>
          </div>
        </div>
